...
import io.github.pixeldungeonmultiplayer.shattered.network.actions.serializers.*;
import io.github.pixeldungeonmultiplayer.shattered.network.serializers.*;
import io.github.pixeldungeonmultiplayer.shattered.network.serializers.windows.*;
import io.github.pixeldungeonmultiplayer.shattered.network.serializers.windows.wnddialog.*;
...
import io.github.pixeldungeonmultiplayer.shattered.network.serializers.windows.wnddialog.wndoptions.*;
...
import io.github.pixeldungeonmultiplayer.shattered.server.network.serializers.emitters.EmitterAnchorSerializer;
...
public class Server extends Thread {
    ...
    static {
        ...
        SERIALIZERS.register(HeroClass.class, "default", new HeroClassSerializer());
        SERIALIZERS.register(HeroSubClass.class, "default", new HeroSubClassSerializer());
        SERIALIZERS.register(Talent.class, "default", new TalentSerializer());
        SERIALIZERS.register(TalentState.class, "default", new TalentStateSerializer());
        SERIALIZERS.register(ArmorAbility.class, "default", new ArmorAbilitySerializer());
        SERIALIZERS.register(ArmorAbilityState.class, "default", new ArmorAbilityStateSerializer());
